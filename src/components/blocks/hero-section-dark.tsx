      ...
      <div className={cn("relative", className)} ref={ref} {...props}>
        ...
        <section className="relative max-w-full mx-auto z-1">
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-28 gap-12 md:px-8">
            ...
            {bottomImage && (
              <div className="mt-32 mx-10 relative z-10 max-w-xs md:max-w-sm mx-auto">
                <video
                  autoPlay
                  muted
                  loop
                  ...
                  preload="auto"
                  controls
                  className="w-full h-auto aspect-[9/16] object-contain shadow-lg rounded-lg border border-gray-200 dark:border-gray-800"
                  poster="/images/video-poster.jpg"
                  ref={videoRef}
                >
                  <source src="/videos/data schoool office.mp4" type="video/mp4" />
